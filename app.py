...
@app.route('/about')
def about():
    return render_template_string(get_html("<div class='movie-page'><h1>О нас</h1><p>Films_Iliaz Pro — ваш лучший онлайн-кинотеатр с подборками фильмов.</p></div>"))

@app.route('/contacts')
def contacts():
    return render_template_string(get_html("<div class='movie-page'><h1>Контакты</h1><p>Связаться с админом можно по почте: admin@filmsiliaz.com</p></div>"))

@app.route('/cookies')
def cookies():
    return render_template_string(get_html("<div class='movie-page'><h1>Политика Cookie</h1><p>Мы используем файлы cookie для улучшения работы сайта и показа рекламы.</p></div>"))
